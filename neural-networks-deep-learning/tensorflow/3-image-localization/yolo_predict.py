...
from yolo_utils import read_classes, read_anchors, generate_colors, preprocess_image, scale_boxes, draw_boxes
from yad2k.models.keras_yolo import yolo_eval, yolo_head, yolo_boxes_to_corners, preprocess_true_boxes, yolo_loss, yolo_body
...
scores, boxes, classes = yolo_eval(yolo_outputs, image_shape, score_threshold=0.2)
